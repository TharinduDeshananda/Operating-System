...
;KERNEL START
	BITS 16
	%DEFINE BubbleOs_VER '1.0.0'	 ;OS version number
	%DEFINE BubbleOs_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as BubbleOs and its programs
...
option_screen:
	...
	os_init_msg		db '                  ______:: TDeshananda OS ::_______                        ', 0
	os_version_msg		db '', 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db '', 0

	dialog_string_1		db 'choose Option to get System Information', 0
	dialog_string_2		db 'Please select getInfo for HardwareInfo or', 0
	dialog_string_3		db 'select Quit for exit the OS.', 0
